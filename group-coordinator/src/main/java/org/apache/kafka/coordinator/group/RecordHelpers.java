...
public class RecordHelpers {
    ...
    public static Record newMemberSubscriptionRecord(
        String groupId,
        String memberId,
        ConsumerGroupMemberSubscription newConsumerGroupMemberSubscription
    ) {
        return new Record(
            ...
            new ApiMessageAndVersion(
                new ConsumerGroupMemberMetadataValue()
                    .setRackId(newConsumerGroupMemberSubscription.rackId())
                    .setInstanceId(newConsumerGroupMemberSubscription.instanceId())
                    .setClientId(newConsumerGroupMemberSubscription.clientId())
                    .setClientHost(newConsumerGroupMemberSubscription.clientHost())
                    .setSubscribedTopicNames(newConsumerGroupMemberSubscription.subscribedTopicNames())
                    .setSubscribedTopicRegex(newConsumerGroupMemberSubscription.subscribedTopicRegex())
                    .setServerAssignor(newConsumerGroupMemberSubscription.serverAssignorName())
                    .setRebalanceTimeoutMs(newConsumerGroupMemberSubscription.rebalanceTimeoutMs())
                    .setAssignors(newConsumerGroupMemberSubscription.assignorStates().stream().map(assignorState ->
