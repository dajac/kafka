...
/**
 * An immutable representation of a consumer group.
 */
public class ConsumerGroupState {
    ...
    public boolean equals(Object o) {
        ...
        ConsumerGroupState that = (ConsumerGroupState) o;

        if (!groupId.equals(that.groupId)) return false;
        if (!groupEpoch.equals(that.groupEpoch)) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + groupEpoch.hashCode();
    ...
    public String toString() {
        return "ConsumerGroupState(groupId=" + groupId +
